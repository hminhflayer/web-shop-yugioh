...
namespace WebShop.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var webShopContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailID,OrderID,ProductID,Money,Quantity,TotalMoney")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailID,OrderID,ProductID,Money,Quantity,TotalMoney")] OrderDetail orderDetail)
        {
